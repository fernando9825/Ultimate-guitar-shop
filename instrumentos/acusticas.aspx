<%@ Page Title="" Language="C#" MasterPageFile="~/instrumentos/guitarras.master" AutoEventWireup="true" CodeFile="acusticas.aspx.cs" Inherits="instrumentos_acusticas" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <tr>
        ...
        <td>&nbsp;</td>
        <td>
            <asp:Label ID="lblacususuario" runat="server" style="font-family: Verdana, Geneva, Tahoma, sans-serif; font-weight: bold; font-size: large; background-color: #FFFFFF" Text="Invitado"></asp:Label>
